            ...
            <form class="row g-3 FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/userAjax.php" method="POST">
                ...
                <div class="row offset-2">
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            <input class="form-control" name="clave1" id="clave1" type="password" value="" placeholder="Ingresar Contraseña">
                            <button class="btn password-toggle-btn btn-outline-secondary" type="button" id="togglePassword1">
                                <img src="<?php echo APP_URL; ?>app/views/icons/eye.png" alt="Toggle Password" width="32" height="32">
                            </button>
                        </div>
                    </div>
                </div>
                <div class="row offset-2">
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            <input class="form-control" name="clave2" id="clave2" type="password" value="" placeholder="Repetir Contraseña">
                            <button class="btn password-toggle-btn btn-outline-secondary" type="button" id="togglePassword2">
                                <img src="<?php echo APP_URL; ?>app/views/icons/eye.png" alt="Toggle Password" width="32" height="32">
                            </button>
                        </div>
                    </div>
