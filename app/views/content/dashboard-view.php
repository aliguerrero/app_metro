                    ...
                    <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                        <div>
                            <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                                    <svg class="icon">
                                        <use
                                            xlink:href="<?php echo APP_URL; ?>app/views/icons/svg/free.svg#cil-arrow-bottom">
                                        </use>
                                    </svg>)</span></div>
                            <div>O.T.</div>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-transparent text-white p-0" type="button"
                                ...
                                <svg class="icon">
                                    <use xlink:href="<?php echo APP_URL; ?>app/views/icons/svg/free.svg#cil-options">
                                    </use>
                                </svg>
                            </button>
                    ...
                    <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                        <div>
                            <div class="fs-4 fw-semibold">15 <span class="fs-6 fw-normal">(40.9%
                                    <svg class="icon">
                                        <use
                                            xlink:href="<?php echo APP_URL; ?>app/views/icons/svg/free.svg#cil-arrow-top">
                                        </use>
                                    </svg>)</span></div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title mb-0">Tabla de O.T.</h4>
                                <div class="small text-medium-emphasis">Febrero - 2024</div>
                            </div>
                            <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                                ...
                                <button class="btn btn-primary" type="button">
                                    <svg class="icon">
                                        <use
                                            xlink:href="<?php echo APP_URL; ?>app/views/icons/svg/free.svg#cil-cloud-download">
                                        </use>
                                    </svg>
                                </button>
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="row row-cols-1 row-cols-md-5 text-center">
                            <div class="col mb-sm-2 mb-0">
                                <div class="text-medium-emphasis">Ejecutadas</div>
                            ...
                            <div class="col mb-sm-2 mb-0">
                                <div class="text-medium-emphasis">Re-programadas</div>
                            ...
                            <div class="col mb-sm-2 mb-0">
                                <div class="text-medium-emphasis">En Ejecucion</div>
                            ...
                            <div class="col mb-sm-2 mb-0">
                                <div class="text-medium-emphasis">No Ejecutadas</div>
                            ...
                            <div class="col mb-sm-2 mb-0">
                                <div class="text-medium-emphasis">Suspendida</div>
                                ...
                                <thead class="table-light fw-semibold">
                                    <tr class="align-middle">
                                        <th class="text-center">
                                            <svg class="icon">
                                                <use
                                                    xlink:href="<?php echo APP_URL; ?>app/views/icons/svg/free.svg#cil-people">
                                                </use>
                                            </svg>
                                        </th>
                                        <th>Usuario</th>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img"
                                                    src="<?php echo APP_URL; ?>app/views/img/avatars/user.png"
                                                    alt="user@email.com"><span class="avatar-status bg-success"></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>Ali Guerrero</div>
                                            <div class="small text-medium-emphasis"><span>Nuevo</span> | Registrado: Jun
                                                1, 2024</div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="clearfix">
                                                ...
                                                <div class="float-end"><small class="text-medium-emphasis">Jun 11, 2024
                                                        - Jul 10,
                                                        2024</small></div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="fw-semibold">12/04/2024</div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
